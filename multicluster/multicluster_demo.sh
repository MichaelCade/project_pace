#!/bin/bash
echo "$(tput setaf 4)Create new cluster 1"
minikube start --addons volumesnapshots,csi-hostpath-driver --apiserver-port=6443 --container-runtime=containerd -p mc-demo1 --kubernetes-version=1.21.2 
...
echo "$(tput setaf 4)Create new cluster 2"
